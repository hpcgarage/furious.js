...
function createEmptyArray(requestId, idOut, shape, dataType) {
	...
	var arrview = new Int32Array(arrbuf);
	arrview[0] = 99;
	var arr = Module._malloc(32);
	Module.HEAP32.set(arrview, arr/4);
	idPtrMap[idOut] = arr;
	console.log("Running Create");
	var arrindex = idPtrMap[idOut];
	var retarray = Module.HEAP32.subarray(arrindex/4, arrindex/4+8);
	for (var i = 0; i < 8; i++) {	
