...
static void lupdecompositionF32(size_t n, float data[restrict static n*n], float data[restrict static n*n], float data[restrict static n*n], bool isLower);
static void lupdecompositionF64(size_t n, double data[restrict static n*n], bool isLower);
