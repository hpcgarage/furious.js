...
/**
 * Raises a matrix to a power (A^b)
 * 
 * @method matrixPower
 * @param {NDArray} a - the array to raise to a power
 * @param {Number} b - the power to raise matrix A to
 * @param {NDArray} [out] - the array where the result is to be stored.
 */
JSContext.prototype.matrixPower = function(a, b, out) {
	util.checkSquare2DArray(a, "a");
	return binaryArithOp(a, b, out, this, jsmath.matrixPower, jsmath.mpConst, jsmath.mpRevConst);
};

/**
 * Rounds all array elements to the number of decimals given
 * equiv: round
 *
 * @method around
 * @param {NDArray} a - the array to round
 * @param {Number} decimals - the decimal place at which to round
 * @param {NDArray} [out] - the array where the result is to be stored.
 */
JSContext.prototype.around = function(a, decimals, out) {
	return binaryArithOp(a, decimals, out, this, jsmath.round, jsmath.roundConst, jsmath.roundRevConst);
};
 ...
 * @param {NDArray} [out] - the array where the result is to be stored.
 */
JSContext.prototype.round = function(a, decimals, out) {
	return binaryArithOp(a, decimals, out, this, jsmath.round, jsmath.roundConst, jsmath.roundRevConst);
};

/**
 * Computes natural logarithm of e^(a+b) for each element a,b in the arrays
 *
 * @method logaddexp
 * @param {NDArray} a - the array of input elementsa 
 * @param {NDArray} b - the second array of input elements.
 ...
 */
JSContext.prototype.logaddexp = function(a, b, out) {
	return binaryArithOp(a, b, out, this, jsmath.logaddexp, jsmath.laeConst, jsmath.laeRevConst);
};

/**
 * Computes base 2 logarithm of 2^(a+b) for each element a,b in the arrays
 *
 * @method logaddexp2
 ...
 * @param {NDArray} [out] - the array for computed logarithm values. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.logaddexp2 = function(a, b, out) {
	return binaryArithOp(a, b, out, this, jsmath.logaddexp2, jsmath.lae2Const, jsmath.lae2RevConst);
};
...
/**
 * Exponentiates array elements and subtracts one from the result.
 *
 * @method expm1
 * @param {NDArray} a - the array of elements to be exponentiated.
 * @param {NDArray} [out] - the array for exponentiated elements. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.expm1 = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.expm1);
};

/**
 * Exponentiates array elements with base 2.
 *
 * @method exp2
 * @param {NDArray} a - the array of elements to be exponentiated.
 * @param {NDArray} [out] - the array for exponentiated elements. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.exp2 = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.exp2);
};
 ...
 * @param {NDArray} [out] - the array for computed logarithm values. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.log10 = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.log10);
};
 ...
 * @param {NDArray} [out] - the array for computed logarithm values. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.log2 = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.log2);
};

/**
 * Computes logarithm of array elements and adds 1.
 *
 * @method log1p
 * @param {NDArray} a - the array of input elements.
 * @param {NDArray} [out] - the array for computed logarithm values. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.log1p = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.log1p);
};
 ...
 * 
 * @method sin
 * @param {NDArray} a - the array of elements whose sine will be calculated.
 * @param [out] - the array of elements whose sine was calculated.
 */
JSContext.prototype.sin = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.sin);
};

/**
 * Calculates the cosine of array elements.
 * 
 * @method cos
 * @param {NDArray} a - the array of elements whose cosine will be calculated.
 * @param [out] - the array of elements whose cosine was calculated.
 */
JSContext.prototype.cos = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.cos);
};
 ...
 * 
 * @method tan
 * @param {NDArray} a - the array of elements whose tangent will be calculated.
 * @param [out] - the array of elements whose tangent was calculated.
 */
JSContext.prototype.tan = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.tan);
};

/**
 * Calculates the arcsine of array elements.
 * 
 * @method arcsin
 * @param {NDArray} a - the array of elements whose arcsine will be calculated.
 * @param [out] - the array of elements whose arcsine was calculated.
 */
JSContext.prototype.arcsin = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.arcsin);
};

/**
 * Calculates the arccosine of array elements.
 * 
 * @method arccos
 * @param {NDArray} a - the array of elements whose arccosine will be calculated.
 * @param [out] - the array of elements whose arccosine was calculated.
 */
JSContext.prototype.arccos = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.arccos);
};

/**
 * Calculates the arctangent of array elements.
 * 
 * @method arctan
 * @param {NDArray} a - the array of elements whose arctangent will be calculated.
 * @param [out] - the array of arctangent calculations.
 */
JSContext.prototype.arctan = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.arctan);
};
 ...
 * 
 * @method degrees
 * @param {NDArray} a - the array of radians
 * @param [out] - the array of degrees
 */
JSContext.prototype.degrees = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.degrees);
};
 ...
 * 
 * @method radians
 * @param {NDArray} a - the array of degrees
 * @param [out] - the array of radians
 */
JSContext.prototype.radians = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.radians);
};
 ...
 * @method rint
 * @param {NDArray} a - the array to round
 * @param [out] - the rounded output
 */
JSContext.prototype.rint = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.rint);
};
 ...
 * @param [out] - the rounded output
 */
JSContext.prototype.fix = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.fix);
};
 ...
 * @param [out] - the rounded output
 */
JSContext.prototype.floor = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.floor);
};
 ...
 * @param [out] - the rounded output
 */
JSContext.prototype.ceil = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.ceil);
};

/**
 * Chops off all fractional value.
 * 
 * @method trunc
 * @param {NDArray} a - the array to truncate
 * @param [out] - the truncated output
 */
JSContext.prototype.trunc = function(a, out) {
	return unaryArithOp(a, out, this, jsmath.trunc);
};
/**
...
/**
 * Computes LUP decomposition of an s.p.d. matrix
 *
 * @method lupdecomposition
 * @param {NDArray} a - a square 2-dimensional matrix to be factored.
 * @param {NDArray} [outL] - a square 2-dimensional array to be used to store the Lower triangular matrix. If supplied, must match the dimensions and data type of the **a** array.
 * @param {NDArray} [outU] - a square 2-dimensional array to be used to store the Upper triangular matrix. If supplied, must match the dimensions and data type of the **a** array.
 * @param {NDArray} [outP] - a square 2-dimensional array to be used to store the permutation matrix. If supplied, must match the dimensions and data type of the **a** array.
 */
JSContext.prototype.lupdecomposition = function(a, outL, outU, outP) {
	util.checkSquare2DArray(a, "a");
	kind = util.checkTriangularKind(kind, "U");
	a._decRef();
	try {
		if (typeof outL === "undefined") {
			outL = new NDArray(a.shape, a.dataType, this);
			if (!a._hasRefs()) {
				outL._data = a._data;
			} else {
				outL._data = new outL.dataType.arrayType(a._data);
			}
		} else {
			util.checkSquare2DArray(outL, "outL");
			util.checkShapesCompatibility(outL.shape, a.shape);
			util.checkDataTypesCompatibility(outL.dataType, a.dataType);
			outL._data.set(a._data);
			outL._incRef();
		}
		if (typeof outU === "undefined") {
			outU = new NDArray(a.shape, a.dataType, this);
			outU._data = new outU.dataType.arrayType(a._data);
		} else {
			util.checkSquare2DArray(outU, "outU");
			util.checkShapesCompatibility(outU.shape, a.shape);
			util.checkDataTypesCompatibility(outU.dataType, a.dataType);
			outU._incRef();
		}
		if (typeof outP === "undefined") {
			outP = new NDArray(a.shape, a.dataType, this);
			outP._data = new outP.dataType.arrayType(a._data);
		} else {
			util.checkSquare2DArray(outP, "outP");
			util.checkShapesCompatibility(outP.shape, a.shape);
			util.checkDataTypesCompatibility(outP.dataType, a.dataType);
			outP._incRef();
		}
	} catch (e) {
		/* Restore the previous state */
	...
	// Note that a has been stored in outL
	jsmath.lupdecomposition(outL._data, outU._data, outP._data, a.shape[0]);
	a._tryInvalidate();
	return [outL, outU, outP];
};
...
JSContext.prototype.outerProduct = function(a, b, out) {
	//Create the shape of out
	//Traverse along each dimension of A and output a_i * b_j \foreach j
	return out;
};

JSContext.prototype.norm = function(a, order, axis, out) {
	if(order == "fro") {
		//frobenius norm
	}
	else if(order == "inf") {
...
JSContext.prototype.cond = function(a, p, out) {
	var normVal = 0;
	var aInverse = this.zeros(a.shape, a.dataType);
	JSContext.prototype.norm(a, p, 0, null, normVal);
	JSContext.prototype.inverse(a, aInverse);
	JSContext.prototype.norm(aInverse, p, 0, null, out);
	return out * normVal;
};

JSContext.prototype.det = function(a, out) {
	//todo: write code for minor
};

JSContext.prototype.inverse = function(a, out) {
