...
WebWorkerContext.prototype.matrixPower = function(a, b, out) {
	return this._messagingContext.matrixPower(a, b, out);
};

WebWorkerContext.prototype.around = function(a, b, out) {
	return this._messagingContext.around(a, b, out);
};

WebWorkerContext.prototype.round = function(a, b, out) {
	return this._messagingContext.round(a, b, out);
};

WebWorkerContext.prototype.logaddexp = function(a, b, out) {
	return this._messagingContext.logaddexp(a, b, out);
};

WebWorkerContext.prototype.logaddexp2 = function(a, b, out) {
...
WebWorkerContext.prototype.expm1 = function(a, out) {
	return this._messagingContext.expm1(a, out);
};

WebWorkerContext.prototype.exp2 = function(a, out) {
...
WebWorkerContext.prototype.log10 = function(a, out) {
	return this._messagingContext.log10(a, out);
};

WebWorkerContext.prototype.log2 = function(a, out) {
	return this._messagingContext.log2(a, out);
};

WebWorkerContext.prototype.log1p = function(a, out) {
...
WebWorkerContext.prototype.sin = function(a, out) {
	return this._messagingContext.sin(a, out);
};

WebWorkerContext.prototype.cos = function(a, out) {
	return this._messagingContext.cos(a, out);
};

WebWorkerContext.prototype.tan = function(a, out) {
	return this._messagingContext.tan(a, out);
};

WebWorkerContext.prototype.arcsin = function(a, out) {
	return this._messagingContext.arcsin(a, out);
};

WebWorkerContext.prototype.arccos = function(a, out) {
	return this._messagingContext.arccos(a, out);
};

WebWorkerContext.prototype.arctan = function(a, out) {
	return this._messagingContext.arctan(a, out);
};

WebWorkerContext.prototype.degrees = function(a, out) {
	return this._messagingContext.degrees(a, out);
};

WebWorkerContext.prototype.radians = function(a, out) {
	return this._messagingContext.radians(a, out);
};

WebWorkerContext.prototype.rint = function(a, out) {
	return this._messagingContext.rint(a, out);
};

WebWorkerContext.prototype.fix = function(a, out) {
	return this._messagingContext.fix(a, out);
};

WebWorkerContext.prototype.floor = function(a, out) {
	return this._messagingContext.floor(a, out);
};

WebWorkerContext.prototype.ceil = function(a, out) {
	return this._messagingContext.ceil(a, out);
};

WebWorkerContext.prototype.trunc = function(a, out) {
...
WebWorkerContext.prototype.lupdecomposition = function(a, outL, outU, outP) {
	return this._messagingContext.lupdecomposition(a, outL, outU, outP);
};
