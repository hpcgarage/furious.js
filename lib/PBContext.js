...
var LUPDecompositionRequest = requests.LUPDecompositionRequest;
...
PBContext.prototype.matrixPower = function(a, b, out) {
	return binaryArithOp(a, b, out, this,
		BinaryOperationRequest.Type.MATP,
		BinaryConstOperationRequest.Type.MATPC,
		BinaryConstOperationRequest.Type.MATPRC);
};

PBContext.prototype.around = function(a, b, out) {
	return binaryArithOp(a, b, out, this,
		BinaryOperationRequest.Type.ARND,
		BinaryConstOperationRequest.Type.ARNDC,
		BinaryConstOperationRequest.Type.ARNDRC);
};

PBContext.prototype.round = function(a, b, out) {
	return binaryArithOp(a, b, out, this,
		BinaryOperationRequest.Type.ROUND,
		BinaryConstOperationRequest.Type.ROUNDC,
		BinaryConstOperationRequest.Type.ROUNDRC);
};

PBContext.prototype.logaddexp = function(a, b, out) {
	return binaryArithOp(a, b, out, this,
		BinaryOperationRequest.Type.LAE,
		BinaryConstOperationRequest.Type.LAEC,
		BinaryConstOperationRequest.Type.LAERC);
};

PBContext.prototype.logaddexp2 = function(a, b, out) {
	return binaryArithOp(a, b, out, this,
		BinaryOperationRequest.Type.LAE2,
		BinaryConstOperationRequest.Type.LAE2C,
		BinaryConstOperationRequest.Type.LAE2RC);
};
...
PBContext.prototype.expm1 = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.EXPM1);
};

PBContext.prototype.exp2 = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.EXP2);
};
...
PBContext.prototype.log10 = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.LOG10);
};

PBContext.prototype.log2 = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.LOG2);
};

PBContext.prototype.log1p = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.LOG1P);
};
...
PBContext.prototype.sin = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.SIN);
};

PBContext.prototype.cos = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.COS);
};

PBContext.prototype.tan = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.TAN);
};

PBContext.prototype.arcsin = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.ASIN);
};

PBContext.prototype.arccos = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.ACOS);
};

PBContext.prototype.arctan = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.ATAN);
};

PBContext.prototype.degrees = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.DEG);
};

PBContext.prototype.radians = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.RAD);
};

PBContext.prototype.rint = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.RINT);
};

PBContext.prototype.fix = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.FIX);
};

PBContext.prototype.floor = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.FLOOR);
};

PBContext.prototype.ceil = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.CEIL);
};

PBContext.prototype.trunc = function(a, out) {
	return unaryArithOp(a, out, this,
		UnaryOperationRequest.Type.TRUNC);
};
...
PBContext.prototype.lupdecomposition = function(a, outL, outU, outP) {
	var idA = a._id;
	var releaseIdA = !a._decRef();
	if (releaseIdA) {
		a._id = 0;
	...
	var request = new Request();
	request.id = allocator.newMessageId();
	request.type = Request.Type.LUP_DECOMPOSITION;
	var lupDecompositionRequest = new LUPDecompositionRequest();
	lupDecompositionRequest.idA = (releaseIdA ? -idA : idA);
	lupDecompositionRequest.idOutL = outL._id;
	lupDecompositionRequest.idOutU = outU._id;
	lupDecompositionRequest.idOutP = outP._id;
	request.lupDecompositionRequest = lupDecompositionRequest;
	this._postMessage(request.encodeAB());
