...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		shell: {
			...
			emcc: {
				command: "emcc lib/asmjs/AsmJSWorker.c -o furious-asmjs-worker.js -s EXPORTED_FUNCTIONS=\"['_createConstArray', '_fillDiag', '_linspace', '_add', '_sub', '_mul', '_mdiv', '_addConst', '_subConst', '_subRevConst', '_mulConst', '_divConst', '_divRevConst', '_sum', '_min', '_max']\" --post-js furious-asmjs-worker.js"
			},
			build: {
				command: "ninja"
			}
